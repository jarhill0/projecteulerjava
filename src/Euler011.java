public class Euler011 {
    ...
    static private int height = grid.length;
    static private int width = grid[0].length;

    static private Integer calculate() {
        Integer bestValue = 0;
        Integer prod;
        ...
        for (int x = 0; x + 3 < width; x++) {
            for (int y = 0; y < height; y++) {
                ...
                bestValue = prod > bestValue ? prod : bestValue;
            }
        }
